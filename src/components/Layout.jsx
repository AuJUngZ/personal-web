...
export default function Layout() {
  return (
    <div className="group/design-root relative flex min-h-screen w-full overflow-x-hidden bg-background text-foreground">
      ...
      <div className="layout-container flex h-full grow flex-col">
        ...
        <main className="flex-1 px-4 py-5 sm:px-8">
          <div className="layout-content-container mx-auto flex max-w-6xl flex-col">
            <Outlet />
          </div>
        </main>
